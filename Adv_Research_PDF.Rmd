...
[^1]:Cohen's \(f\) = `r sqrt(.79/(1-.79)) #this calculates in-line`; to make sure my scientific notation skills are on par -> 1.198907e-07 < .001 = `r 1.198907e-07 < 0.001 #this will result in a logical statement (TRUE/FALSE)` 
